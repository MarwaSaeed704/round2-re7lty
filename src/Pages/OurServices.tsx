      ...
      <>
          ...
          <div className='pt-14 w-full'>
              <div className='text-center mb-4'>
                  <p className='main-font second-color font-black text-[24px] max-sm:text-[16px]'>تمتع في رحلتك</p>
                  <h2 className='main-font text-[#191919] font-black text-[48px] tracking-[-2%] max-sm:text-[24px]'>مجموعة من خدماتنا</h2>     
              </div>
              ...
              <div className='flex relative p-10 pt-18 m-10 bg-[#F1EFFD] rounded-3xl max-sm:flex-col max-sm:gap-10 '>
                  ...
                  {/* service#1 */}
                  <div className=' '>
                      <img src={travel_v1} className='w-2/6 m-auto' />
                  ...
                  {/*== service#1 ==*/}
                   ...
                   {/* service#2 */}
                  <div className=' '>
                      <img src={travelv210} className='w-2/6 m-auto' />
                      <div className='w-4/6 m-auto text-center'>
                            <h3 className='main-font text-[#191919] font-black text-[24px] tracking-[-2%] max-sm:text-[20px]'>دليل سياحي</h3>
                            <p className='main-font text-[#4C4C4C] font-[400] text-[18px] tracking-[-3%] max-sm:text-[17px]'>
                                نقدم لك خدمات الإرشاد السياحي لبناء
                  ...
                  {/*== service#2 ==*/}
                   ...
                   {/* service#3 */}
                  <div className=' '>
                      <img src={travel203} className='w-2/6 m-auto' />
                      <div className='w-4/6 m-auto text-center'>
